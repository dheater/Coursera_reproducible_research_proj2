...
statedata$EVTYPE=with(statedata, sub(".*STORM SURGE.*","FLOODING", EVTYPE, ignore.case=T))

statedata$EVTYPE=with(statedata, sub(".*WIND.*","HIGH WIND", EVTYPE, ignore.case=T))

statedata$EVTYPE=with(statedata, sub(".*DUST.*","DUST STORM", EVTYPE, ignore.case=T))

statedata$EVTYPE=with(statedata, sub(".*FOG.*","FOG", EVTYPE, ignore.case=T))
